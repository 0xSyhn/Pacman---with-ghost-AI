...
from game_over import game_over_window, check_pacman_lost
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                restart_button, close_button = game_over_window(pacman_instance.score, window, window_width, window_height)
        ...
        if not game_over:
            ...
            # Check if Pacman lost
            if check_pacman_lost(pacman_instance, ghosts) or pacman_instance.score == 2590:
                game_over = True
